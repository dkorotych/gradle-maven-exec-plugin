...
Releases of this plugin are hosted on https://login.gradle.org/plugin/com.github.dkorotych.gradle-maven-exec[Gradle's Plugin Repository].
...
If you run into any issues, consult the https://github.com/dkorotych/gradle-maven-exec-plugin/blob/master/FAQ.md[F.A.Q.] first.
